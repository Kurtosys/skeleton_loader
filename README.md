@kurtosys/skeleton_loader

# skeleton_loader
SkeletonLoader library with reusable component, for any project.

[![npm (scope)](https://img.shields.io/npm/v/npm.svg)]
(https://github.com/BlaineLingard/skeleton_loader.io)
[![npm bundle size (minified)](https://img.shields.io/bundlephobia/min/react.svg)](https://github.com/BlaineLingard/skeleton_loader.io)

It's the tiniest!

You can preview our skeletonloader [link to Demo!](https://skeletonloader.netlify.com/)
